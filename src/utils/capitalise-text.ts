 ...
 * The capitalised format of the text 'sam mbakwe' is
 * 'Sam Mbakwe' and 'SAM MBAKWE' would be 'Sam Mbakwe'.
...
export const capitaliseArrayText = (wordsArray: string[] | undefined) => {
